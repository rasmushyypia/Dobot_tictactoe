...
class TicTacToeGUI(tk.Tk):
    ...
    def load_images(self):
        try:
            self.empty_cell_img = PhotoImage(file="assets/empty.png")
            self.x_img = PhotoImage(file='assets/x.png')
            self.o_img = PhotoImage(file='assets/o.png')
    ...
    def create_top_area(self):
        ...
        self.current_player_text = tk.Label(self.player_frame, text="Current Player: ", font=("Impact", 20))
        self.current_player_text.pack(side=tk.LEFT)

        self.current_player_symbol = tk.Label(self.player_frame, text="X", font=("Helvetica", 20, "bold"), fg='red')
        ...
        self.results_label = tk.Label(self.results_frame, text=self.get_results_text(), font=("Helvetica", 14, "bold"))
